    ...
    private static class Chomosone {
        ...
        public Chomosone(int target) {
            ...
            for(int y=0;y<chromoLen;y++) {
                ...
                // Append the chromo, Always append 4 digit number. chromo , final size will be 20.
        ...
        public final int addUp() {
            ...
            while (ptr<decodedString.length()) {
                ...
                if (num && !Character.isDigit(ch)) {ptr++;continue;}    //If previous is not a number and current is not a number
                if (!num && Character.isDigit(ch)) {ptr++;continue;}    //If previous is a number and current is a number, Both can be happened alternately in 2 conditions
